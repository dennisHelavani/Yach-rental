                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="space-y-8 mb-12">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-punchy uppercase text-lg mb-1">Follow Us</h4>
                                    <a href="https://www.instagram.com/saltie_cruises/" target="_blank" rel="noopener noreferrer" className="text-slate-500 font-medium hover:text-primary transition-colors inline-block">@saltie_cruises</a>
                                    <p className="text-xs text-slate-400 mt-1">Stay up to date on Instagram.</p>
                                </div>
                            </div>
                        </div>
